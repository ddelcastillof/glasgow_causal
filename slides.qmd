...
footer: "Presentation for the MRC/CSO Social and Public Health Sciences Unit, University of Glasgow"
...
:::{.callout-important title = "Definitions of poverty in the UK [@Francis-Devine2025]"}
...
:::{.callout-warning title = "How we measure poverty?"}
...
![**Burden of disease in older adults in UK [@Chen2025-vs]**](figs/Chen2025.png){width=50%}
...
- These estimates could be used to model the impact of social policies on health outcomes through simulations.
...
:::
::: {.column width="50%"}
![**Different definitions of income[@Igelstrom2024-by]**](figs/Igelstrom-Fig1A.png)
:::
:::
...
- Can model time-varying effect modification[@Robins2007-en]
